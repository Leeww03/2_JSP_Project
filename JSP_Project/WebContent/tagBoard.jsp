    ...
    <jsp:include page="L_Side.jsp" flush="false" /><!-- L-side -->
        <div id="MenuBoard">
        	<%
        		...
        		list = bdao.gettagboard(str,end,tag); 
        	%>
        	...
        	<%
						...
						<div id="all">
							...
							%><a href="tagBoard.jsp?pageNum=<%=endpage - pageBlock%>">[이전]</a>
							<%
								}
							...
							%><a href="tagBoard.jsp?pageNum=<%=i%>">[<%=i%>]
							</a>
							<%
								}
							}
							if (endpage < pageCount) {
							%><a href="tagBoard.jsp?pageNum=<%=strpage + pageBlock%>">[다음]</a>
							<%
								}
							%>
