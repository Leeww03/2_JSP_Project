    ...
    <jsp:include page="L_Side.jsp" flush="false" /><!-- L-side -->
        <div id="MenuBoard">
        	<%
        		...
        		int cnt = bdao.searchboardcnt(search);
        		...
        		list = bdao.getsearchboard(str,end,search); 
        	%>
        	...
        	<%
						...
						<div id="all">
							...
							%><a href="searchBoard.jsp?pageNum=<%=endpage - pageBlock%>">[이전]</a>
							<%
								}
							...
							%><a href="searchBoard.jsp?pageNum=<%=i%>">[<%=i%>]
							</a>
							<%
								}
							}
							if (endpage < pageCount) {
							%><a href="searchBoard.jsp?pageNum=<%=strpage + pageBlock%>">[다음]</a>
							<%
								}
							%>
